...
{
GoalpointTool::GoalpointTool() : rviz_default_plugins::tools::PoseTool(), qos_profile_(5)
{
  shortcut_key_ = 'w';

  topic_property_ = new rviz_common::properties::StringProperty(
    "Topic", "goalpoint", "The topic on which to publish navigation waypionts.",
...
void GoalpointTool::updateTopic()
{
  ...
  sub_ = raw_node->template create_subscription<nav_msgs::msg::Odometry>(
    "odometry", 5, std::bind(&GoalpointTool::odomHandler, this, std::placeholders::_1));

  pub_ = raw_node->template create_publisher<geometry_msgs::msg::PointStamped>(
    "goal_point", qos_profile_);
